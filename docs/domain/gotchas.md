...
| `[NET/SYNC]` | WebSocket Server/Client, Đồng Bộ Delta, Heartbeat Ping/Pong, Grace Period, Reconnect | #11, #17, #27, #38, #40, #41, #44, #45, #65, #66, #67, #70, #71, #74, #75, #76, #77, #100, #105, #106, #114, #144, #156, #159, #165, #168, #184, #190, #200, #203, #209, #210, #211, #212, #213, #215, #217, #223, #224, #225, #226, #227, #231, #235, #244, #247, #248, #249, #250, #255, #256, #259 |
...
- **Traceability**: `tests/client/activity_tracker.test.ts`, `tests/client/floating_numbers.test.ts`, `tests/contracts/imp190_specialized_devices_and_camera_snap.test.ts`, `src/client/network/apply_delta.ts`, `src/client/game_canvas.tsx`, `src/client/ui/in_app_browser_banner.tsx`, `src/client/audio/audio_engine.ts`, `src/client/ui/camera_reset_pill.tsx`.
