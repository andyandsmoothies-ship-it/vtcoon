...
# Impeccable Manual Edit Applier (Antigravity 2.0)
...
- Repository root.
- Scripts path (`.agents/skills/impeccable/scripts/`).
- Event id.
- Page URL.
...
```json
{"status":"done","appliedEntryIds":["entry-id"],"files":["src/App.jsx"],"notes":[]}
```
