...
export const CHANCE_CARD_DETAILS: Readonly<Record<ChanceCardId, CardDetail>> = {
  [ChanceCardId.CC_PLATE_AUCTION]: {
    ...
    effectDetail: 'Nộp lệ phí đấu giá 500, nhận đặc quyền tung xúc xắc đi tiếp một lượt bổ sung',
    duration: 'Tức thì',
    destination: 'Nộp 500 vào Kho Bạc Nhà Nước',
    effectDelta: -500,
  },
  [ChanceCardId.CC_TAX_AUDIT]: {
    ...
    effectDetail: 'Nộp phạt 500 cho mỗi ô đất trống Cấp 0 chưa xây dựng công trình vào Kho Bạc Nhà Nước (khung phạt điều chỉnh từ 200)',
    duration: 'Tức thì',
  ...
  [ChanceCardId.CC_STOCK_PROFIT]: {
    ...
    targetScope: 'Người chơi rút thẻ',
    effectDetail: 'Chốt lời cổ phiếu danh mục VN30 thành công, nhận ngay 2.500 tiền mặt',
    duration: 'Tức thì',
    destination: 'Cộng 2.500 vào số dư tài khoản cá nhân',
    effectDelta: 2500,
  },
  ...
  [ChanceCardId.CC_CONTRACT_PENALTY]: {
    ...
    effectDetail: 'Bồi thường vi phạm hợp đồng 1.000 chuyển trực tiếp cho người chơi có số dư thấp nhất bàn cờ (người nghèo nhất)',
    duration: 'Tức thì',
    destination: 'Trừ 1.000 chuyển sang tài khoản người nghèo nhất',
    effectDelta: -1000,
  },
  [ChanceCardId.CC_LAND_CHANGE]: {
    ...
    effectDetail: 'Nộp lệ phí 500 vào Kho Bạc, nâng cấp ngay 1 ô đất Cấp 0 lên Cấp 1 không cần hoàn thành nhóm màu. Nếu không có ô Cấp 0, nhận 600 hỗ trợ từ Kho Bạc',
    duration: 'Tức thì',
  ...
  [ChanceCardId.CC_BUILD_HALT]: {
    ...
    effectDetail: 'Phạt ngay 800 chi phí thanh tra hoàn thiện pháp lý và tạm ngưng thu tiền thuê tại 1 ô đất trong 2 vòng',
    duration: '2 vòng chơi',
    destination: 'Nộp phạt 800 vào Kho Bạc Nhà Nước',
    effectDelta: -800,
  },
  [ChanceCardId.CC_MA_FORCE]: {
    ...
    effectDetail: 'Mua lại 1 ô đất cấp 0 của đối thủ theo giá 120%, hoặc nhận 800 trợ cấp từ Kho Bạc nếu không có mục tiêu hợp lệ',
    duration: 'Tức thì',
  ...
  [ChanceCardId.CC_COPYRIGHT]: {
    ...
    targetScope: 'Người chơi rút thẻ',
    effectDetail: 'Xử phạt vi phạm hành chính bản quyền thương hiệu và chương trình biểu diễn 1.200 vào Kho Bạc Nhà Nước',
    duration: 'Tức thì',
    destination: 'Nộp phạt 1.200 vào Kho Bạc Nhà Nước',
    effectDelta: -1200,
  },
  [ChanceCardId.CC_OVERDRAFT]: {
    description: 'Giải ngân hạn mức thấu chi bổ sung vốn lưu động, hoàn trả gốc và lãi sau 3 vòng.',
    targetScope: 'Người chơi rút thẻ',
    effectDetail: 'Giải ngân tạm ứng vốn lưu động 3.000, hoàn trả 3.300 gồm gốc và lãi sau 3 vòng',
    duration: '3 vòng chơi',
    destination: 'Nhận ngay 3.000, hoàn trả 3.300 nộp Kho Bạc sau 3 vòng',
    effectDelta: 3000,
  },
  [ChanceCardId.CC_JUNK_STOCK]: {
    description: 'Làn sóng bán tháo diện rộng làm mất thanh khoản, buộc bạn phải cắt lỗ danh mục.',
    targetScope: 'Người chơi rút thẻ',
    effectDetail: 'Trừ -1.500 nộp Kho Bạc do kẹp hàng cổ phiếu rác mất thanh khoản',
    duration: 'Tức thì',
    destination: 'Nộp -1.500 vào Kho Bạc Nhà Nước',
    effectDelta: -1500,
  },
  [ChanceCardId.CC_FRANCHISE]: {
    ...
    effectDetail: 'Thu phí nhượng quyền kinh doanh chuỗi F&B 800 từ mỗi đối thủ',
    duration: 'Tức thì',
  ...
  [ChanceCardId.CC_VENUE_INCIDENT]: {
    ...
    targetScope: 'Người chơi rút thẻ',
    effectDetail: 'Chi phí khắc phục sự cố dịch vụ 1.200; nếu không có ô Dịch vụ nộp 600 phí bảo an toàn thành phố vào Kho Bạc Nhà Nước',
    duration: 'Tức thì',
    destination: 'Nộp phạt vào Kho Bạc Nhà Nước',
    effectDelta: -1200,
  },
  [ChanceCardId.CC_CONCERT_SPONSOR]: {
    ...
    targetScope: 'Người chơi rút thẻ',
    effectDetail: 'Chi phí tài trợ lễ hội âm nhạc 600, nhận hiệu ứng nhân đôi kết quả xúc xắc ở lượt tiếp theo',
    duration: 'Lượt tiếp theo',
    destination: 'Trừ 600 nộp vào Kho Bạc Nhà Nước',
    effectDelta: -600,
  },
  [ChanceCardId.CC_FREE_CREDIT]: {
    ...
    targetScope: 'Người chơi rút thẻ',
    effectDetail: 'Nhận ngay 2.000 tiền mặt, nộp lãi 400 mỗi lần đi qua ô Khởi Hành (GO)',
    duration: 'Duy trì đến hết trận hoặc khi tất toán',
    destination: 'Giải ngân 2.000 vào tài khoản, nộp lãi 400 vào Kho Bạc khi qua ô GO',
    effectDelta: 2000,
  },
  [ChanceCardId.CC_PORT_EXCLUSIVE]: {
    ...
    effectDetail: 'Nhận ngay 1.000 cổ tức logistics từ Kho Bạc và trích nhận 50% doanh thu phí vận tải khi người chơi khác dừng chân tại ô Cảng biển trong 2 vòng',
    duration: '2 vòng chơi',
    destination: 'Kho Bạc giải ngân 1.000 và trích 50% phí cảng về tài khoản',
    effectDelta: 1000,
  },
  [ChanceCardId.CC_SLOW_BUILD]: {
    ...
    effectDetail: 'Phạt 600 nộp Kho Bạc cho ô đất Cấp 0 và bắt đầu đếm hạn thu hồi; nếu mất khả năng thanh toán (số dư âm), ô đất bị thu hồi tức thì. Không có ô C0 nộp phí hành chính 300.',
  ...
  [ChanceCardId.CC_MEDIA_CRISIS]: {
    ...
    effectDetail: 'Phạt ngay 800 chi phí xử lý khủng hoảng truyền thông và tạm đình chỉ thu phí tại 1 ô Dịch vụ trong 2 vòng',
    duration: '2 vòng chơi',
    destination: 'Nộp phạt 800 vào Kho Bạc Nhà Nước',
    effectDelta: -800,
  },
...
export const MARKET_CARD_DETAILS: Readonly<Record<MarketCardId, MarketCardDetail>> = {
  [MarketCardId.MC_NIGHT_ECONOMY]: {
    ...
    effectDetail: 'Tất cả người chơi chi tiêu 400 kích cầu (chia đều cho các chủ ô Dịch vụ hoặc nộp Kho Bạc) và nhân đôi tiền thuê ô Dịch vụ Cấp 1 trở lên trong 2 vòng',
    duration: '2 vòng chơi',
  ...
  [MarketCardId.MC_ALCOHOL_CHECK]: {
    ...
    effectDetail: 'Giảm 50% tiền thuê cho chủ ô đất trong 2 vòng. Người dừng chân bị phạt 800 nộp Kho Bạc và giam xe (mất lượt kế tiếp).',
    duration: '2 vòng chơi',
    destination: 'Nộp phạt 800 vào Kho Bạc Nhà Nước',
  },
  [MarketCardId.MC_CASINO_PILOT]: {
    ...
    effectDetail: 'Thưởng ngay 1.500 cho mọi ô Dịch Vụ Cấp 2 trở lên, 3.000 cho ô 27 đạt Cấp 3; nếu chưa ai có ô Dịch vụ C2+, Kho Bạc giải ngân gói kích cầu 1.000 cho người có số dư thấp nhất',
    duration: 'Tức thì',
  ...
  [MarketCardId.MC_FIRE_INSPECTION]: {
    ...
    effectDetail: 'Phạt 200/nhà C1, 400/nhà C2, 800/nhà C3. Đất trống (Cấp 0): Miễn phạt',
    duration: 'Tức thì',
    destination: 'Nộp phạt vào Kho Bạc Nhà Nước',
  },
  [MarketCardId.MC_PUBLIC_INVEST]: {
    ...
    effectDetail: 'Kho Bạc chi trả ngay 400 cho mỗi người chơi; thưởng 1.000 cho mỗi ô Hạ tầng sở hữu và nhân đôi cước phí vận tải trong 2 vòng',
    duration: '2 vòng chơi',
  ...
  [MarketCardId.MC_ANTI_SPECULATE]: {
    ...
    effectDetail: 'Nâng mức thuế suất chuyển nhượng P2P lên 20% trong 1 vòng và phạt ngay 1.000 thuế điều tiết tài sản cho người chơi sở hữu từ 4 ô đất trở lên',
    duration: '1 vòng chơi',
  ...
  [MarketCardId.MC_FUEL_SURGE]: {
    ...
    effectDetail: 'Mỗi người nộp ngay 500 phụ phí nhiên liệu (chủ ô Hạ tầng được nhận, hoặc nộp Kho Bạc nếu chưa ai sở hữu). Trong 2 vòng tới, cước giẫm vào ô Hạ tầng tăng thêm 500.',
    duration: '2 vòng chơi',
  ...
  [MarketCardId.MC_UTILITY_DOUBLE]: {
    ...
    effectDetail: 'Nhân đôi phí tiện ích công cộng trong 2 vòng và tất cả người chơi lập tức nộp 400 tiền điện & cước viễn thông (chia đều cho chủ ô EVN/Viettel hoặc nộp Kho Bạc)',
    duration: '2 vòng chơi',
  ...
  [MarketCardId.MC_COASTAL_STORM]: {
    ...
    effectDetail: 'Chủ sở hữu nộp 400/cấp nhà vào Kho Bạc khắc phục bão lũ; miễn 100% tiền thuê và người dừng chân bị cô lập giao thông (mất lượt kế tiếp) trong 2 vòng',
    duration: '2 vòng chơi',
