...
export const CHANCE_CARD_DETAILS: Readonly<Record<ChanceCardId, CardDetail>> = {
  ...
  [ChanceCardId.CC_TAX_AUDIT]: {
    description: 'Thanh tra thuế doanh nghiệp đột xuất. Nộp phạt 200 Tr. cho mỗi ô đất trống chưa xây dựng.',
    targetScope: 'Người chơi rút thẻ (các ô đất Cấp 0 chưa xây dựng)',
    effectDetail: 'Nộp phạt 200 Tr. cho mỗi ô đất trống Cấp 0 chưa xây dựng công trình vào Kho Bạc Nhà Nước',
    duration: 'Tức thì',
  ...
  [ChanceCardId.CC_BUILD_HALT]: {
    ...
    effectDetail: 'Đình chỉ cấp phép xây dựng và tạm ngưng thu tiền thuê tại 1 ô đất trong 2 vòng',
    duration: '2 vòng chơi',
    destination: 'Đóng băng doanh thu ô dự án',
  },
  ...
  [ChanceCardId.CC_COPYRIGHT]: {
    ...
    targetScope: 'Người chơi rút thẻ',
    effectDetail: 'Xử phạt vi phạm bản quyền thương hiệu và chương trình biểu diễn 400 Tr.',
    duration: 'Tức thì',
    destination: 'Nộp phạt 400 Tr. vào Kho Bạc Nhà Nước',
    effectDelta: -400,
  },
  ...
  [ChanceCardId.CC_FRANCHISE]: {
    ...
    effectDetail: 'Thu phí nhượng quyền kinh doanh chuỗi F&B 300 Tr. từ mỗi đối thủ',
    duration: 'Tức thì',
  ...
  [ChanceCardId.CC_VENUE_INCIDENT]: {
    ...
    targetScope: 'Người chơi rút thẻ',
    effectDetail: 'Chi phí bồi thường và khắc phục sự cố kỹ thuật hạ tầng dịch vụ 800 Tr.',
    duration: 'Tức thì',
    destination: 'Trừ 800 Tr. nộp vào Kho Bạc Nhà Nước',
    effectDelta: -800,
  },
  ...
  [ChanceCardId.CC_PORT_EXCLUSIVE]: {
    ...
    effectDetail: 'Được trích nhận 50% doanh thu phí vận tải khi người chơi khác ghé thăm các ô Cảng biển',
    duration: '2 vòng chơi',
    destination: 'Chuyển 50% phí cảng về tài khoản cá nhân',
  },
  ...
  [ChanceCardId.CC_MEDIA_CRISIS]: {
    ...
    effectDetail: 'Tạm đình chỉ vận hành kinh doanh và thu phí tại 1 ô dịch vụ giải trí trong 1 vòng',
    duration: '1 vòng chơi',
    destination: 'Đóng băng doanh thu tại ô dịch vụ',
  },
  [ChanceCardId.CC_SWAP_PROJECT]: {
    description: 'Quyền ưu tiên hoán đổi vị trí dự án chiến lược với người chơi khác.',
    targetScope: '2 ô đất cùng cấp công trình giữa 2 người chơi',
    effectDetail: 'Kích hoạt quyền hoán đổi quyền sở hữu 1 ô đất tương đương cấp công trình với đối thủ',
    duration: 'Tức thì',
...
export const MARKET_CARD_DETAILS: Readonly<Record<MarketCardId, MarketCardDetail>> = {
  ...
  [MarketCardId.MC_CASINO_PILOT]: {
    description: 'Thí điểm Casino dành cho người Việt: Thưởng ngay 2.000 Tr. cho chủ ô 27 đạt Cấp 3.',
    targetScope: 'Chủ sở hữu ô 27 (Kiên Giang - Phú Quốc) đạt Cấp 3',
    effectDetail: 'Nhận ngay khoản thưởng cổ tức 2.000 Tr. tiền mặt nếu ô 27 đạt Cấp 3',
    duration: 'Tức thì',
  ...
  [MarketCardId.MC_ANTI_SPECULATE]: {
    ...
    effectDetail: 'Nâng mức thuế suất chuyển nhượng P2P từ 5% lên 20% khấu trừ trực tiếp từ bên bán',
    duration: '1 vòng chơi',
  ...
  [MarketCardId.MC_FUEL_SURGE]: {
    ...
    effectDetail: 'Phụ thu thêm 500 Tr. cước logistics vào biểu phí dừng chân tại các trạm hạ tầng giao thông',
    duration: '1 vòng chơi',
  ...
  [MarketCardId.MC_UTILITY_DOUBLE]: {
    ...
    effectDetail: 'Nhân đôi hệ số tính phí tiện ích công cộng dựa trên tổng số điểm xúc xắc',
    duration: '1 vòng chơi',
