...
export const vi = {
  marketCards: {
    ...
    [MarketCardId.MC_RATE_HIKE]:       'Siết Van Tín Dụng',
  ...
  chanceCards: {
    ...
    [ChanceCardId.CC_JUNK_STOCK]:       'Cổ Phiếu "Múa Bên Trăng"',
    ...
    [ChanceCardId.CC_FREE_CREDIT]:      'Vốn Ưu Đãi Khởi Nghiệp',
