...
export function BotTradeOfferModal({
  ...
  const taxAmount = Math.round(price * 0.05);
  const netReceived = price - taxAmount;
      ...
      <div className="p-4 flex flex-col gap-3">
        ...
        >
          ...
          <div className="flex flex-col gap-0.5">
            <span className="font-bold text-amber-950">CẢNH BÁO ĐỘC QUYỀN:</span>
