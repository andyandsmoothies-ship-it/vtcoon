...
export function TradePartnerStrip({
  ...
  return (
    <div className="px-4 py-2 border-b border-slate-200 bg-[#FAF6EE] flex items-center gap-2 overflow-x-auto no-scrollbar scrollbar-none [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
