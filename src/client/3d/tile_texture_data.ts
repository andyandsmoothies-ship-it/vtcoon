...
import { ColorGroup, BOARD_CONFIG, CellType } from '../../domain/board_config';
...
export function isPropertyTile(index: number): boolean {
  return BOARD_CONFIG[index]?.type === CellType.Property;
}

export function isInfrastructureTile(index: number): boolean {
  const type = BOARD_CONFIG[index]?.type;
  return type === CellType.Railroad || type === CellType.Utility;
}
...
export const TILE_METADATA_MAP: Readonly<Record<number, TileMetadata>> = {
  ...
  17: { title: 'THỊ TRƯỜNG', subtitle: 'Phiếu Cơ Chế', actionLabel: 'RÚT THẺ THỊ TRƯỜNG', bannerColor: '#0D9488', category: 'CƠ CHẾ', icon: 'chest' },
  ...
  22: { title: 'CƠ HỘI', subtitle: 'Vận May', actionLabel: 'RÚT THẺ CƠ HỘI', bannerColor: '#EA580C', category: 'VẬN MAY', icon: 'chance' },
  ...
  33: { title: 'THỊ TRƯỜNG', subtitle: 'Phiếu Cơ Chế', actionLabel: 'RÚT THẺ THỊ TRƯỜNG', bannerColor: '#0D9488', category: 'CƠ CHẾ', icon: 'chest' },
  ...
  36: { title: 'CƠ HỘI', subtitle: 'Vận May', actionLabel: 'RÚT THẺ CƠ HỘI', bannerColor: '#EA580C', category: 'VẬN MAY', icon: 'chance' },
  ...
  38: { title: 'SÀN HOSE', subtitle: 'Chứng Khoán', priceLabel: '1D6 ĐẶT CƯỢC', actionLabel: '1D6 ĐẶT CƯỢC', bannerColor: '#0284C7', category: 'TÀI CHÍNH', icon: 'bull' },
