...
export function ProceduralBuilding({
  ...
  return (
    <group ref={rootGroupRef} position={[0, 0.22, -0.42]}>
      ...
      {level === 1 && (
        <group>
          ...
          <mesh position={[0, 0.025, 0]} castShadow receiveShadow>
            <boxGeometry args={[0.58, 0.05, 0.48]} />
            <meshStandardMaterial color="#475569" roughness={0.7} />
          </mesh>

          {/* Thân nhà vàng kem Indochine */}
          <mesh position={[0, 0.18, 0]} castShadow receiveShadow>
            <boxGeometry args={[0.52, 0.28, 0.42]} />
          ...
          {/* Mặt tiền: Ô cửa kính ấm trưng bày sản phẩm */}
      ...
      {level === 2 && (
        <group>
          {/* Khối đế thương mại mang màu nhóm đất */}
          <mesh position={[0, 0.08, 0]} castShadow receiveShadow>
            <boxGeometry args={[0.6, 0.16, 0.5]} />
            <meshStandardMaterial color={groupColor} roughness={0.3} metalness={0.3} />
          </mesh>

          {/* Sảnh đón kính Sapphire tầng trệt */}
          ...
          {/* Thân tháp kính Sapphire PBR phản chiếu môi trường */}
          ...
          <mesh position={[-0.08, 0.72, 0]} castShadow receiveShadow>
      ...
      {level === 3 && (
        <group>
          {/* Bệ cảnh quan cẩm thạch đá hoa cương chân tháp */}
          <mesh position={[0, 0.03, 0]} castShadow receiveShadow>
            <boxGeometry args={[0.62, 0.06, 0.5]} />
            <meshStandardMaterial color="#1E293B" roughness={0.3} metalness={0.2} />
          </mesh>

          {/* Tháp phụ (bên trái, thấp hơn) - phong cách Champagne Gold & Kính Sapphire */}
          <mesh position={[-0.14, 0.32, 0]} castShadow receiveShadow>
            <boxGeometry args={[0.24, 0.52, 0.36]} />
            <meshStandardMaterial color="#FEF3C7" roughness={0.35} metalness={0.25} />
          </mesh>
          {/* Cửa sổ kính sapphire tháp phụ */}
          ...
          <mesh position={[-0.14, 0.6, 0]} castShadow>
            <boxGeometry args={[0.22, 0.03, 0.34]} />
            <meshStandardMaterial
              color="#F59E0B"
              roughness={0.2}
              metalness={0.85}
          ...
          {/* Tháp chính (bên phải) - tháp ngà Art Deco vươn cao */}
          <mesh position={[0.14, 0.42, 0]} castShadow receiveShadow>
            <boxGeometry args={[0.24, 0.72, 0.36]} />
            <meshStandardMaterial color="#FDE68A" roughness={0.25} metalness={0.35} />
          </mesh>
          {/* Cửa sổ kính sapphire tháp chính */}
          ...
          <mesh position={[0.14, 0.94, 0]} castShadow>
            ...
            <meshStandardMaterial color="#FBBF24" roughness={0.1} metalness={1.0} />
          </mesh>
